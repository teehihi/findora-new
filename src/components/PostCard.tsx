...
export const PostCard: React.FC<PostCardProps> = ({ post, onPress }) => {
  ...
  const isLongDescription = Boolean(post.description && post.description.length > 90);

  return (
    <View style={styles.cardContainer}>
      {/* 1. Header: Avatar + Poster Name + Verified Badge + Date + 3-dots (Tapping Header opens Post Detail like Facebook) */}
      <TouchableOpacity 
      ...
      >
        ...
        <TouchableOpacity 
          ...
          onPress={(e) => {
            e.stopPropagation();
            Alert.alert('Tùy chọn', 'Tùy chọn bài đăng');
          }}
        >
      ...
      >
        ...
        <Text 
          ...
          numberOfLines={isExpandedText ? undefined : 2}
          ellipsizeMode="tail"
        >
          {post.description}
        </Text>
